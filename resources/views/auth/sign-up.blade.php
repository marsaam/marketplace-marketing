  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{ route('store-sign-up') }}" method="POST" autocomplete="off" novalidate>
            @csrf
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter company contact" name="company_contact">
              </div>
              <div class="mb-3">
                <label class="form-label">Company Description</label>
                <input type="text" class="form-control" placeholder="Enter company description" name="company_desc">
              </div>
            <div class="mb-3">
